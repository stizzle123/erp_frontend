...
class Normal extends React.Component {
  ...
  render() {
	...
	const tableData = this.state.rowArray.map((prop, key)=> {
	    ...
	    [                   
                  (key+1), 
                    <CustomInput id="Product" required formControlProps={{                    
                    }}
                  />,
                    <CustomInput id="Quality" required formControlProps={{                    
                    }}
                  />,
                    <CustomInput id="Unit" required formControlProps={{                    
                    }}
                  />,
                    <CustomInput id="Amount" required formControlProps={{                    
                    }}
                  />,
                  <Button
					  color="danger"
...
export default withStyles(extendedFormsStyle)(Normal);
